...
AtlasLoot_Data["AtlasLootCrafting"] = {
	...
	SmithingArmorOld3 = {
		...
		{ 4, "s9979", "7936", "=q2=Ornate Mithril Boots", "=ds=Quest"};
		{ 5, "s9972", "7935", "=q2=Ornate Mithril Breastplate", "=ds=Quest"};
		{ 6, "s9980", "7937", "=q2=Ornate Mithril Helm", "=ds=Quest"};
		...
		{ 22, "s9957", "7929", "=q2=Orcish War Leggings", "=ds=Quest"};
	...
	Cooking4 = {
		...
		{ 16, 0, "INV_Box_01", "=q6=World Events", ""};
	...
	Darkironplate = {
		{ 1, 0, "INV_Hammer_20", "=q6=Dark Iron Plate", "=q1=#j11#"};
	...
	Warbearwear = {
		{ 1, 0, "INV_Box_01", "=q6=Warbear Wear", ""};
	...
	Lavaleather = {
		{ 1, 0, "INV_Box_01", "=q6=Lava Leather", "=q1=#j11#"};
	...
	Basiliskscalearmor = {
		{ 1, 0, "INV_Box_01", "=ds=Basilisk Scale Armor", ""};
	...
	Turtlescalearmor = {
		{ 1, 0, "INV_Box_01", "=ds=Turtle Scale Armor", ""};
	...
	Tailchanting1 = {
		{ 1, 0, "INV_Box_01", "=ds=Praise of the Moon", ""};
	...
	-- Manually transcribed from the Atlas-CFM addon (CFMLoot/Data/Tables/Crafting.lua)
	-- for professions this addon's own crafting DB never covered: Jewelcrafting has no
	-- spellId data (custom OctoWoW/Turtle-WoW profession), Survival/Gardening likewise --
	-- so these entries carry itemId only. ClassicAPI's known-recipe detection is spellId-
	-- based, so 'Known by' auto-detection will not populate for these; browsing still works.

	Jewelcrafting1 = {
		{ 1, "29728", "29728", "=q1=Rough Gritted Paper", "=ds=#sr# 1"};
		{ 2, "29730", "29730", "=q1=Rough Copper Ring", "=ds=#sr# 1"};
		{ 3, "29732", "29732", "=q1=Copper Bangle", "=ds=#sr# 1"};
		{ 4, "41001", "41001", "=q1=Bright Copper Ring", "=ds=#sr# 15"};
		{ 5, "41003", "41003", "=q1=Malachite Ring", "=ds=#sr# 20"};
		{ 6, "41249", "41249", "=q1=Bulky Copper Ring", "=ds=#sr# 25"};
		{ 7, "41005", "41005", "=q1=Sturdy Copper Ring", "=ds=#sr# 25"};
		{ 8, "41031", "41031", "=q1=Rough Gemstone Cluster", "=ds=#sr# 35"};
		{ 9, "41007", "41007", "=q1=Inlaid Copper Ring", "=ds=#sr# 35"};
		{ 10, "41009", "41009", "=q1=Copper Staff", "=ds=#sr# 45"};
		{ 11, "41011", "41011", "=q1=Encrusted Copper Bangle", "=ds=#sr# 50"};
		{ 12, "41013", "41013", "=q1=Lesser Fortification Ring", "=ds=#sr# 50"};
		{ 13, "41015", "41015", "=q1=Tigercrest Ring", "=ds=#sr# 50"};
		{ 14, "41231", "41231", "=q1=Minor Trollblood Ring", "=ds=#sr# 50"};
		{ 15, "41017", "41017", "=q1=Small Pearlstone Staff", "=ds=#sr# 55"};
		{ 16, "41019", "41019", "=q1=Amber Ring", "=ds=#sr# 60"};
		{ 17, "41021", "41021", "=q1=Azure Ring", "=ds=#sr# 60"};
		{ 18, "41023", "41023", "=q1=Bright Copper Necklace", "=ds=#sr# 65"};
		{ 19, "41025", "41025", "=q1=Softglow Ring", "=ds=#sr# 65"};
		{ 20, "41247", "41247", "=q1=Small Pearl Ring", "=ds=#sr# 65"};
		{ 21, "41027", "41027", "=q1=Topaz Studded Ring", "=ds=#sr# 70"};
		{ 22, "41029", "41029", "=q1=Coarse Gritted Paper", "=ds=#sr# 70"};
		{ 23, "41560", "41560", "=q1=Ebon Ring", "=ds=#sr# 75"};
		{ 24, "41335", "41335", "=q1=Shining Copper Cuffs", "=ds=#sr# 80"};
		{ 25, "41033", "41033", "=q1=Lavish Gemmed Necklace", "=ds=#sr# 80"};
		{ 26, "41321", "41321", "=q1=Gleaming Chain", "=ds=#sr# 80"};
		{ 27, "41035", "41035", "=q1=Amberstone Pendant", "=ds=#sr# 80"};
		{ 28, "41587", "41587", "=q1=Gloomweed Bindings", "=ds=#sr# 80"};
		{ 29, "41037", "41037", "=q1=Deepmist Choker", "=ds=#sr# 85"};
		{ 30, "41562", "41562", "=q1=The King's Conviction", "=ds=#sr# 85"};
		{ 31, "41732", "41732", "=q1=Shadowmoon Orb", "=ds=#sr# 85"};
		{ 32, "41746", "41746", "=q1=Shadowforged Eye", "=ds=#sr# 85"};
		{ 33, "41039", "41039", "=q1=Rough Bronze Ring", "=ds=#sr# 90"};
		{ 34, "41041", "41041", "=q1=Shimmering Bronze Ring", "=ds=#sr# 90"};
		{ 35, "41043", "41043", "=q1=Amber Orb", "=ds=#sr# 95"};
		{ 36, "41045", "41045", "=q1=Encrusted Bronze Staff", "=ds=#sr# 100"};
		{ 37, "41047", "41047", "=q1=Earthrock Loop", "=ds=#sr# 100"};
		{ 38, "41564", "41564", "=q1=Shadowfall Jewel", "=ds=#sr# 100"};
		{ 39, "41581", "41581", "=q1=Serpent's Coil Staff", "=ds=#sr# 100"};
		{ 40, "41323", "41323", "=q1=Talisman of Stone", "=ds=#sr# 100"};
		Next = "Jewelcrafting2";
		Back = "JEWELCRAFTINGMENU";
	};

	Jewelcrafting2 = {
		{ 1, "41049", "41049", "=q1=Bronze Cuffed Bangles", "=ds=#sr# 105"};
		{ 2, "41051", "41051", "=q1=Shadowgem Band", "=ds=#sr# 105"};
		{ 3, "41726", "41726", "=q1=Hydrathorn Bracers", "=ds=#sr# 105"};
		{ 4, "41740", "41740", "=q1=Mistwood Tiara", "=ds=#sr# 105"};
		{ 5, "41053", "41053", "=q1=Bronze Scepter", "=ds=#sr# 110"};
		{ 6, "41325", "41325", "=q1=Medallion of Flame", "=ds=#sr# 110"};
		{ 7, "41566", "41566", "=q1=Ocean's Wrath", "=ds=#sr# 115"};
		{ 8, "41337", "41337", "=q1=Dawnbright Cuffs", "=ds=#sr# 115"};
		{ 9, "41734", "41734", "=q1=Fangclaw Relic", "=ds=#sr# 120"};
		{ 10, "41055", "41055", "=q1=Pendant of Midnight", "=ds=#sr# 120"};
		{ 11, "41067", "41067", "=q1=Rough Silver Ring", "=ds=#sr# 125"};
		{ 12, "41065", "41065", "=q1=Coarse Gemstone Cluster", "=ds=#sr# 125"};
		{ 13, "41057", "41057", "=q1=Agatestone Crown", "=ds=#sr# 125"};
		{ 14, "41061", "41061", "=q1=Binding Signet", "=ds=#sr# 125"};
		{ 15, "41063", "41063", "=q1=Enchanted Bracelets", "=ds=#sr# 125"};
		{ 16, "41776", "41776", "=q1=Ring of Midnight", "=ds=#sr# 125"};
		{ 17, "34758", "34758", "=q1=Kodoheart Necklace", "=ds=#sr# 125"};
		{ 18, "41059", "41059", "=q1=Moonlight Staff", "=ds=#sr# 125"};
		{ 19, "41568", "41568", "=q1=Dazzling Moonstone Band", "=ds=#sr# 130"};
		{ 20, "41760", "41760", "=q1=Graceful Agate Gemstone", "=ds=#sr# 135"};
		{ 21, "41069", "41069", "=q1=Silver Medallion", "=ds=#sr# 135"};
		{ 22, "41071", "41071", "=q1=Ring of Purified Silver", "=ds=#sr# 135"};
		{ 23, "41327", "41327", "=q1=Gleaming Silver Necklace", "=ds=#sr# 135"};
		{ 24, "41339", "41339", "=q1=Circlet of Dampening", "=ds=#sr# 135"};
		{ 25, "41748", "41748", "=q1=Totem of Self Preservation", "=ds=#sr# 135"};
		{ 26, "41583", "41583", "=q1=Farraki Ceremony Totem", "=ds=#sr# 140"};
		{ 27, "41728", "41728", "=q1=Blackrock Ironclamps", "=ds=#sr# 140"};
		{ 28, "41570", "41570", "=q1=Harpy Talon Ring", "=ds=#sr# 145"};
		{ 29, "41742", "41742", "=q1=Venomspire Diadem", "=ds=#sr# 145"};
		{ 30, "41201", "41201", "=q1=Heavy Gritted Paper", "=ds=#sr# 150"};
		{ 31, "41203", "41203", "=q1=Heavy Gemstone Cluster", "=ds=#sr# 150"};
		{ 32, "41627", "41627", "=q1=Pristine Crystal Gemstone", "=ds=#sr# 150"};
		{ 33, "41607", "41607", "=q1=Shimmering Aqua Gemstone", "=ds=#sr# 150"};
		{ 34, "41081", "41081", "=q1=Rough Iron Ring", "=ds=#sr# 150"};
		{ 35, "41083", "41083", "=q1=Rough Gold Ring", "=ds=#sr# 150"};
		{ 36, "41205", "41205", "=q1=Goldfire Crystal Bracelet", "=ds=#sr# 155"};
		{ 37, "41207", "41207", "=q1=Quartz Halo", "=ds=#sr# 155"};
		{ 38, "41275", "41275", "=q1=Gemmed Citrine Pendant", "=ds=#sr# 160"};
		{ 39, "41572", "41572", "=q1=Centaur Hoof Circlet", "=ds=#sr# 160"};
		{ 40, "41331", "41331", "=q1=Gem Encrusted Choker", "=ds=#sr# 160"};
		Next = "Jewelcrafting3";
		Prev = "Jewelcrafting1";
		Back = "JEWELCRAFTINGMENU";
	};
	...
	Jewelcrafting3 = {
		{ 1, "41736", "41736", "=q1=Netherbane Rod", "=ds=#sr# 160"};
		{ 2, "41329", "41329", "=q1=Ring of The Turtle", "=ds=#sr# 160"};
		{ 3, "41283", "41283", "=q1=Astral Amulet", "=ds=#sr# 1"};
		{ 4, "41209", "41209", "=q1=Staff of Blossomed Jade", "=ds=#sr# 165"};
		{ 5, "41333", "41333", "=q1=Goldcrest Amulet", "=ds=#sr# 170"};
		{ 6, "41730", "41730", "=q1=Monastery Emberbrace", "=ds=#sr# 170"};
		{ 7, "41211", "41211", "=q1=Jade Harmony Circlet", "=ds=#sr# 170"};
		{ 8, "41585", "41585", "=q1=Sphinx's Wisdom Staff", "=ds=#sr# 170"};
		{ 9, "41574", "41574", "=q1=Ogre Bone Band", "=ds=#sr# 170"};
		{ 10, "41219", "41219", "=q1=Rough Mithril Ring", "=ds=#sr# 175"};
		{ 11, "41629", "41629", "=q1=Gleaming Jade Gemstone", "=ds=#sr# 175"};
		{ 12, "41623", "41623", "=q1=Pure Shining Moonstone", "=ds=#sr# 175"};
		{ 13, "41752", "41752", "=q1=Obsidian Brooch", "=ds=#sr# 175"};
		{ 14, "41213", "41213", "=q1=Goldenshade Quartz Crown", "=ds=#sr# 175"};
		{ 15, "41215", "41215", "=q1=The Golden Goblet", "=ds=#sr# 175"};
		{ 16, "41217", "41217", "=q1=Powerful Citrine Pendant", "=ds=#sr# 175"};
		{ 17, "41591", "41591", "=q1=Spectre Shade Ring", "=ds=#sr# 180"};
		{ 18, "93", "93", "=q1=Refined Dwarven Necklace", "=ds=#sr# 185"};
		{ 19, "104", "104", "=q1=Ancient Dwarven Gemstone", "=ds=#sr# 185"};
		{ 20, "41556", "41556", "=q1=Delicate Mithril Amulet", "=ds=#sr# 180"};
		{ 21, "41221", "41221", "=q1=Ironsun Citrine Ring", "=ds=#sr# 185"};
		{ 22, "41750", "41750", "=q1=Facetted Moonstone Brooch", "=ds=#sr# 185"};
		{ 23, "41589", "41589", "=q1=Crystal Earring", "=ds=#sr# 185"};
		{ 24, "41263", "41263", "=q1=Ocean's Gaze", "=ds=#sr# 190"};
		{ 25, "41223", "41223", "=q1=Shimmering Gold Necklace", "=ds=#sr# 190"};
		{ 26, "41225", "41225", "=q1=Ironbloom Ring", "=ds=#sr# 190"};
		{ 27, "41541", "41541", "=q1=Dazzling Aquamarine Loop", "=ds=#sr# 190"};
		{ 28, "41579", "41579", "=q1=Marine's Demise", "=ds=#sr# 190"};
		{ 29, "41285", "41285", "=q1=Shimmering Moonstone Tablet", "=ds=#sr# 195"};
		{ 30, "41229", "41229", "=q1=Solid Gritted Paper", "=ds=#sr# 200"};
		{ 31, "41233", "41233", "=q1=Rough Truesilver Ring", "=ds=#sr# 200"};
		{ 32, "41237", "41237", "=q1=Solid Gemstone Cluster", "=ds=#sr# 200"};
		{ 33, "41603", "41603", "=q1=Radiant Ember Gemstone", "=ds=#sr# 200"};
		{ 34, "41631", "41631", "=q1=Illuminated Gemstone", "=ds=#sr# 200"};
		{ 35, "41738", "41738", "=q1=Marine Root", "=ds=#sr# 200"};
		{ 36, "41227", "41227", "=q1=Ornate Mithril Scepter", "=ds=#sr# 200"};
		{ 37, "41546", "41546", "=q1=Alluring Citrine Choker", "=ds=#sr# 200"};
		{ 38, "41548", "41548", "=q1=Elaborate Golden Bracelets", "=ds=#sr# 200"};
		{ 39, "41550", "41550", "=q1=Heart of the Sea", "=ds=#sr# 200"};
		{ 40, "41744", "41744", "=q1=Bloodfire Circlet", "=ds=#sr# 200"};
		Next = "Jewelcrafting4";
		Prev = "Jewelcrafting2";
		Back = "JEWELCRAFTINGMENU";
	};
	...
	Jewelcrafting4 = {
		{ 1, "41754", "41754", "=q1=Smoldering Brooch", "=ds=#sr# 200"};
		{ 2, "41552", "41552", "=q1=Staff of Gallitrea", "=ds=#sr# 200"};
		{ 3, "41558", "41558", "=q1=Draenethyst Baton", "=ds=#sr# 200"};
		{ 4, "41718", "41718", "=q1=Ornate Mithril Bracelets", "=ds=#sr# 200"};
		{ 5, "41756", "41756", "=q1=Vitriol Brooch", "=ds=#sr# 205"};
		{ 6, "41239", "41239", "=q1=Greater Binding Signet", "=ds=#sr# 210"};
		{ 7, "41786", "41786", "=q1=Ornate Mithril Crown", "=ds=#sr# 210"};
		{ 8, "41554", "41554", "=q1=Golden Jade Ring", "=ds=#sr# 210"};
		{ 9, "41354", "41354", "=q1=Skyfire Jewel", "=ds=#sr# 210"};
		{ 10, "41352", "41352", "=q1=Opaline Illuminator", "=ds=#sr# 210"};
		{ 11, "41307", "41307", "=q1=Gemkeeper's Folio", "=ds=#sr# 1"};
		{ 12, "41235", "41235", "=q1=Aquamarine Pendant", "=ds=#sr# 215"};
		{ 13, "41241", "41241", "=q1=Royal Gemstone Staff", "=ds=#sr# 215"};
		{ 14, "41277", "41277", "=q1=Starforge Amulet", "=ds=#sr# 220"};
		{ 15, "41243", "41243", "=q1=Emberstone Idol", "=ds=#sr# 220"};
		{ 16, "41245", "41245", "=q1=Runed Truesilver Ring", "=ds=#sr# 220"};
		{ 17, "41633", "41633", "=q1=Burning Star Gemstone", "=ds=#sr# 225"};
		{ 18, "41085", "41085", "=q1=Emberstone Studded Ring", "=ds=#sr# 225"};
		{ 19, "41281", "41281", "=q1=Runebound Amulet", "=ds=#sr# 230"};
		{ 20, "41716", "41716", "=q1=Crown of Elegance", "=ds=#sr# 230"};
		{ 21, "41784", "41784", "=q1=Mana Binding Signet", "=ds=#sr# 230"};
		{ 22, "41305", "41305", "=q1=Golden Scepter of Authority", "=ds=#sr# 1"};
		{ 23, "41635", "41635", "=q1=Brilliant Opal Gemstone", "=ds=#sr# 235"};
		{ 24, "41770", "41770", "=q1=Dense Gemstone Cluster", "=ds=#sr# 235"};
		{ 25, "41087", "41087", "=q1=Rough Thorium Ring", "=ds=#sr# 235"};
		{ 26, "41720", "41720", "=q1=Regal Twilight Staff", "=ds=#sr# 240"};
		{ 27, "41724", "41724", "=q1=Ornament of Restraint", "=ds=#sr# 245"};
		{ 28, "41089", "41089", "=q1=Mithril Blackstone Necklace", "=ds=#sr# 245"};
		{ 29, "41261", "41261", "=q1=Sunburst Tiara", "=ds=#sr# 250"};
		{ 30, "41091", "41091", "=q1=Dense Gritted Paper", "=ds=#sr# 250"};
		{ 31, "41714", "41714", "=q1=Opal Guided Bangles", "=ds=#sr# 250"};
		{ 32, "41637", "41637", "=q1=Elegant Emerald Gemstone", "=ds=#sr# 250"};
		{ 33, "41639", "41639", "=q1=Shining Sapphire Gemstone", "=ds=#sr# 1"};
		{ 34, "41093", "41093", "=q1=Radiant Thorium Twilight", "=ds=#sr# 255"};
		{ 35, "41348", "41348", "=q1=Crystalfire Armlets", "=ds=#sr# 255"};
		{ 36, "41265", "41265", "=q1=Starry Thorium Band", "=ds=#sr# 260"};
		{ 37, "41611", "41611", "=q1=Gloomy Diamond Gemstone", "=ds=#sr# 260"};
		{ 38, "41095", "41095", "=q1=Glyph Codex", "=ds=#sr# 260"};
		{ 39, "41350", "41350", "=q1=Cinderfall Band", "=ds=#sr# 260"};
		{ 40, "41251", "41251", "=q1=Blue Starfire", "=ds=#sr# 265"};
		Next = "Jewelcrafting5";
		Prev = "Jewelcrafting3";
		Back = "JEWELCRAFTINGMENU";
	};
	...
	Jewelcrafting5 = {
		{ 1, "41273", "41273", "=q1=Prism Amulet", "=ds=#sr# 265"};
		{ 2, "41774", "41774", "=q1=Spellweaver Pendant", "=ds=#sr# 265"};
		{ 3, "41097", "41097", "=q1=Spellweaver Rod", "=ds=#sr# 265"};
		{ 4, "41099", "41099", "=q1=Quicksilver Whirl", "=ds=#sr# 265"};
		{ 5, "41762", "41762", "=q1=Dreary Opal Gemstone", "=ds=#sr# 270"};
		{ 6, "41311", "41311", "=q1=Stellar Gemguards", "=ds=#sr# 270"};
		{ 7, "41315", "41315", "=q1=Moonlit Charm", "=ds=#sr# 275"};
		{ 8, "41641", "41641", "=q1=Unstable Arcane Gemstone", "=ds=#sr# 275"};
		{ 9, "41356", "41356", "=q1=Gemstone Compendium", "=ds=#sr# 275"};
		{ 10, "41279", "41279", "=q1=Voidheart Charm", "=ds=#sr# 280"};
		{ 11, "41101", "41101", "=q1=Crystalweft Bracers", "=ds=#sr# 280"};
		{ 12, "41103", "41103", "=q1=Ethereal Frostspark Crown", "=ds=#sr# 280"};
		{ 13, "41105", "41105", "=q1=Pendant of Arcane Radiance", "=ds=#sr# 280"};
		{ 14, "41794", "41794", "=q1=Orb of Clairvoyance", "=ds=#sr# 285"};
		{ 15, "41313", "41313", "=q1=Garnet Guardian Staff", "=ds=#sr# 290"};
		{ 16, "41643", "41643", "=q1=Glittering Sapphire Gemstone", "=ds=#sr# 290"};
		{ 17, "41309", "41309", "=q1=Stellar Ruby Ring", "=ds=#sr# 300"};
		{ 18, "41287", "41287", "=q1=Stormcloud Sigil", "=ds=#sr# 290"};
		{ 19, "41708", "41708", "=q1=Opalstone Circle", "=ds=#sr# 290"};
		{ 20, "41712", "41712", "=q1=Dark Iron Signet Ring", "=ds=#sr# 290"};
		{ 21, "41271", "41271", "=q1=Pure Gold Ring", "=ds=#sr# 295"};
		{ 22, "41253", "41253", "=q1=Emerald Monarch's Glow", "=ds=#sr# 300"};
		{ 23, "41259", "41259", "=q1=Arcanum Baton", "=ds=#sr# 300"};
		{ 24, "41722", "41722", "=q1=Pendant of Instability", "=ds=#sr# 300"};
		{ 25, "41700", "41700", "=q1=Embergem Cuffs", "=ds=#sr# 300"};
		{ 26, "41706", "41706", "=q1=Mastercrafted Diamond Crown", "=ds=#sr# 300"};
		{ 27, "41764", "41764", "=q1=Resurged Topaz Gemstone", "=ds=#sr# 300"};
		{ 28, "41768", "41768", "=q1=Resilient Arcane Gemstone", "=ds=#sr# 300"};
		{ 29, "41798", "41798", "=q1=Guardbreaker Charm", "=ds=#sr# 300"};
		{ 30, "41804", "41804", "=q1=Bindings of Luminance", "=ds=#sr# 300"};
		{ 31, "41806", "41806", "=q1=Crown of the Illustrious Queen", "=ds=#sr# 300"};
		{ 32, "41802", "41802", "=q1=Spire of Channeled Power", "=ds=#sr# 300"};
		{ 33, "41808", "41808", "=q1=Mastercrafted Diamond Bangles", "=ds=#sr# 300"};
		{ 34, "41778", "41778", "=q1=Stormcloud Shackles", "=ds=#sr# 300"};
		{ 35, "41303", "41303", "=q1=Massive Jewel Circlet", "=ds=#sr# 300"};
		{ 36, "41317", "41317", "=q1=Twilight Opal Cascade", "=ds=#sr# 300"};
		{ 37, "36905", "36905", "=q1=Grandstaff of the Shen'dralar Elder", "=ds=#sr# 300"};
		{ 38, "41605", "41605", "=q1=Glowing Ruby Gemstone", "=ds=#sr# 200"};
		{ 39, "41601", "41601", "=q1=Sharpened Citrine Gemstone", "=ds=#sr# 200"};
		{ 40, "41621", "41621", "=q1=Enchanted Emerald Gemstone", "=ds=#sr# 250"};
		Next = "Jewelcrafting6";
		Prev = "Jewelcrafting4";
		Back = "JEWELCRAFTINGMENU";
	};
	...
	Jewelcrafting6 = {
		{ 1, "41625", "41625", "=q1=Beautiful Diamond Gemstone", "=ds=#sr# 270"};
		{ 2, "41609", "41609", "=q1=Azerothian Ruby Gemstone", "=ds=#sr# 275"};
		{ 3, "41617", "41617", "=q1=Tempered Azerothian Gemstone", "=ds=#sr# 275"};
		{ 4, "41613", "41613", "=q1=Flawless Black Gemstone", "=ds=#sr# 285"};
		{ 5, "41615", "41615", "=q1=Arcane Emerald Gemstone", "=ds=#sr# 295"};
		{ 6, "41619", "41619", "=q1=Stunning Imperial Gemstone", "=ds=#sr# 300"};
		{ 7, "41821", "41821", "=q1=Gorgeous Mountain Gemstone", "=ds=#sr# 300"};
		{ 8, "36591", "36591", "=q1=Crystalized Topaz Gemstone", "=ds=#sr# 0"};
		{ 9, "36581", "36581", "=q1=Ceremonial Furbolg Pendant", "=ds=#sr# 0"};
		{ 10, "41782", "41782", "=q1=Golden Runed Ring", "=ds=#sr# 285"};
		{ 11, "41780", "41780", "=q1=Stormcloud Signet", "=ds=#sr# 290"};
		{ 12, "41710", "41710", "=q1=Deep Sapphire Circlet", "=ds=#sr# 290"};
		{ 13, "41790", "41790", "=q1=Ring of Unleashed Potential", "=ds=#sr# 290"};
		{ 14, "41255", "41255", "=q1=Sapphire Luminescence", "=ds=#sr# 300"};
		{ 15, "41696", "41696", "=q1=Shimmering Diamond Band", "=ds=#sr# 300"};
		{ 16, "41698", "41698", "=q1=Crown of Molten Ascension", "=ds=#sr# 300"};
		{ 17, "41702", "41702", "=q1=Blackwing Signet of Command", "=ds=#sr# 300"};
		{ 18, "41704", "41704", "=q1=Talisman of Hinderance", "=ds=#sr# 300"};
		{ 19, "41788", "41788", "=q1=Blazefury Circlet", "=ds=#sr# 300"};
		{ 20, "41267", "41267", "=q1=Ruby Ring of Ruin", "=ds=#sr# 300"};
		{ 21, "41269", "41269", "=q1=Encrusted Gemstone Ring", "=ds=#sr# 300"};
		{ 22, "41792", "41792", "=q1=Empowered Domination Rod", "=ds=#sr# 300"};
		{ 23, "41796", "41796", "=q1=Grail of Forgotten Memories", "=ds=#sr# 300"};
		{ 24, "41800", "41800", "=q1=Rudeus' Focusing Cane", "=ds=#sr# 300"};
		Prev = "Jewelcrafting5";
		Back = "JEWELCRAFTINGMENU";
	};

	Survival1 = {
		{ 1, "46064", "46064", "=q1=Dim Torch", "=ds=#sr# 1"};
		{ 2, "36765", "36765", "=q1=Bundle of Simple Sticks", "=ds=#sr# 5"};
		{ 3, "47103", "47103", "=q1=Driftwood Fishing Pole", "=ds=#sr# 10"};
		{ 4, "47101", "47101", "=q1=Survivalist's Skinning Knife", "=ds=#sr# 10"};
		{ 5, "36768", "36768", "=q1=Crude Hatchet", "=ds=#sr# 15"};
		{ 6, "36769", "36769", "=q1=Crude Hunting Bow", "=ds=#sr# 15"};
		{ 7, "36767", "36767", "=q1=Crude Machete", "=ds=#sr# 15"};
		{ 8, "36766", "36766", "=q1=Crude Walking Stick", "=ds=#sr# 15"};
		{ 9, "36770", "36770", "=q1=Copper Lantern", "=ds=#sr# 20"};
		{ 10, "36771", "36771", "=q1=Simple Slingshot", "=ds=#sr# 30"};
		{ 11, "36773", "36773", "=q1=Makeshift Rations Bag", "=ds=#sr# 40"};
		{ 12, "36772", "36772", "=q1=Simple Herbalist's Backpack", "=ds=#sr# 40"};
		{ 13, "36774", "36774", "=q1=Weak Healing Salve", "=ds=#sr# 50"};
		{ 14, "36785", "36785", "=q1=Makeshift Knife", "=ds=#sr# 60"};
		{ 15, "36786", "36786", "=q1=Gardening Gloves", "=ds=#sr# 65"};
		{ 16, "36787", "36787", "=q1=Crude Fishing Rod", "=ds=#sr# 70"};
		{ 17, "46072", "46072", "=q1=Traveler's Tent", "=ds=#sr# 80"};
		{ 18, "36788", "36788", "=q1=Hunting Spear", "=ds=#sr# 90"};
		{ 19, "36789", "36789", "=q1=Gardening Broom", "=ds=#sr# 95"};
		{ 20, "36844", "36844", "=q1=Healing Salve", "=ds=#sr# 100"};
		{ 21, "36842", "36842", "=q1=Oakwood Bow", "=ds=#sr# 100"};
		{ 22, "36843", "36843", "=q1=Simple Fishing Lure", "=ds=#sr# 100"};
		{ 23, "36845", "36845", "=q1=Fishing Bag", "=ds=#sr# 105"};
		{ 24, "36846", "36846", "=q1=Skinner's Pack", "=ds=#sr# 110"};
		{ 25, "46073", "46073", "=q1=Fishing Boat", "=ds=#sr# 115"};
		{ 26, "36847", "36847", "=q1=Gardening Pitchfork", "=ds=#sr# 120"};
		{ 27, "30071", "30071", "=q1=Blackmouth Fishing Trap", "=ds=#sr# 125"};
		{ 28, "36849", "36849", "=q1=Bundle of Bright Wood Sticks", "=ds=#sr# 125"};
		{ 29, "36848", "36848", "=q1=Murloc Scale Coat", "=ds=#sr# 125"};
		{ 30, "46066", "46066", "=q1=Murloc's Flippers", "=ds=#sr# 125"};
		{ 31, "36853", "36853", "=q1=Sturdy Blade", "=ds=#sr# 130"};
		{ 32, "36851", "36851", "=q1=Sturdy Cane", "=ds=#sr# 130"};
		{ 33, "36852", "36852", "=q1=Sturdy Knife", "=ds=#sr# 130"};
		{ 34, "36850", "36850", "=q1=Sturdy Net", "=ds=#sr# 130"};
		{ 35, "36854", "36854", "=q1=Reliable Fishing Rod", "=ds=#sr# 135"};
		{ 36, "36856", "36856", "=q1=Hat of the Junior Chef", "=ds=#sr# 140"};
		{ 37, "30073", "30073", "=q1=Rugged Mining Sack", "=ds=#sr# 140"};
		{ 38, "36855", "36855", "=q1=Throwable Net", "=ds=#sr# 140"};
		{ 39, "36858", "36858", "=q1=Bright Wood Arrows", "=ds=#sr# 145"};
		{ 40, "36857", "36857", "=q1=Treasure Compass", "=ds=#sr# 145"};
		Next = "Survival2";
		Back = "SURVIVALMENU";
	};

	Survival2 = {
		{ 1, "36860", "36860", "=q1=Potent Healing Salve", "=ds=#sr# 150"};
		{ 2, "36861", "36861", "=q1=Spicy Fishing Lure", "=ds=#sr# 150"};
		{ 3, "36859", "36859", "=q1=Studded Rations Bag", "=ds=#sr# 150"};
		{ 4, "30004", "30004", "=q1=Slowing Bolas", "=ds=#sr# 155"};
		{ 5, "46075", "46075", "=q1=Iron Lantern", "=ds=#sr# 160"};
		{ 6, "30078", "30078", "=q1=Snap Trap", "=ds=#sr# 160"};
		{ 7, "30006", "30006", "=q1=Edged Machete", "=ds=#sr# 165"};
		{ 8, "30008", "30008", "=q1=Iron Spear", "=ds=#sr# 165"};
		{ 9, "30010", "30010", "=q1=Reinforced Fishing Rod", "=ds=#sr# 170"};
		{ 10, "30015", "30015", "=q1=Bundle of Shade Wood Sticks", "=ds=#sr# 175"};
		{ 11, "30084", "30084", "=q1=Firefin Fishing Trap", "=ds=#sr# 175"};
		{ 12, "30013", "30013", "=q1=Water Trudgers", "=ds=#sr# 175"};
		{ 13, "46068", "46068", "=q1=Cleaning Cloth", "=ds=#sr# 180"};
		{ 14, "30017", "30017", "=q1=Sharpened Herb Sickle", "=ds=#sr# 180"};
		{ 15, "30022", "30022", "=q1=Lined Wintercloak", "=ds=#sr# 185"};
		{ 16, "30024", "30024", "=q1=Sleek Pinewood Bow", "=ds=#sr# 190"};
		{ 17, "36747", "36747", "=q1=Jungle Remedy", "=ds=#sr# 195"};
		{ 18, "30029", "30029", "=q1=Savory Fishing Lure", "=ds=#sr# 200"};
		{ 19, "30027", "30027", "=q1=Superior Healing Salve", "=ds=#sr# 200"};
		{ 20, "36795", "36795", "=q1=Nutritious Rations", "=ds=#sr# 205"};
		{ 21, "36796", "36796", "=q1=Shade Wood Arrows", "=ds=#sr# 205"};
		{ 22, "36798", "36798", "=q1=Hiking Staff", "=ds=#sr# 215"};
		{ 23, "36799", "36799", "=q1=Tree Hatchet", "=ds=#sr# 215"};
		{ 24, "36797", "36797", "=q1=Vine Cutter", "=ds=#sr# 215"};
		{ 25, "36800", "36800", "=q1=Bundle of Tropical Sticks", "=ds=#sr# 225"};
		{ 26, "46077", "46077", "=q1=Repaired Electro-Lantern", "=ds=#sr# 230"};
		{ 27, "36801", "36801", "=q1=Sunshade Hat", "=ds=#sr# 235"};
		{ 28, "36802", "36802", "=q1=Thick Rations Bag", "=ds=#sr# 235"};
		{ 29, "36805", "36805", "=q1=Aromatic Berries", "=ds=#sr# 240"};
		{ 30, "36804", "36804", "=q1=Spiced Berries", "=ds=#sr# 240"};
		{ 31, "36803", "36803", "=q1=Warped Recurve Bow", "=ds=#sr# 240"};
		{ 32, "36806", "36806", "=q1=Advanced Camouflage", "=ds=#sr# 245"};
		{ 33, "36807", "36807", "=q1=Emergency Parachute", "=ds=#sr# 250"};
		{ 34, "36809", "36809", "=q1=Premium Fishing Lure", "=ds=#sr# 250"};
		{ 35, "36808", "36808", "=q1=Stabilizing Healing Salve", "=ds=#sr# 250"};
		{ 36, "30031", "30031", "=q1=Smooth Ironfeather Arrows", "=ds=#sr# 255"};
		{ 37, "30033", "30033", "=q1=Heavy Duty Machete", "=ds=#sr# 260"};
		{ 38, "30035", "30035", "=q1=Thorium Edged Machete", "=ds=#sr# 260"};
		{ 39, "30037", "30037", "=q1=Thorium Spear", "=ds=#sr# 265"};
		{ 40, "30042", "30042", "=q1=Bundle of Star Wood Sticks", "=ds=#sr# 270"};
		Next = "Survival3";
		Prev = "Survival1";
		Back = "SURVIVALMENU";
	};
	...
	Survival3 = {
		{ 1, "30039", "30039", "=q1=Razor-sharp Skinning Knife", "=ds=#sr# 270"};
		{ 2, "30045", "30045", "=q1=Mastercraft Fishing Rod", "=ds=#sr# 275"};
		{ 3, "30086", "30086", "=q1=Stonescale Fishing Trap", "=ds=#sr# 275"};
		{ 4, "30050", "30050", "=q1=Miner's Rucksack", "=ds=#sr# 280"};
		{ 5, "30052", "30052", "=q1=Herbalist's Knapsack", "=ds=#sr# 285"};
		{ 6, "30054", "30054", "=q1=Skinner's Carryall", "=ds=#sr# 285"};
		{ 7, "30065", "30065", "=q1=Fisherman's Backpack", "=ds=#sr# 285"};
		{ 8, "30057", "30057", "=q1=Cooling Rations Bag", "=ds=#sr# 290"};
		{ 9, "30069", "30069", "=q1=Oil-Powered Cooker", "=ds=#sr# 295"};
		{ 10, "30067", "30067", "=q1=Starfeather Arrows", "=ds=#sr# 300"};
		{ 11, "30063", "30063", "=q1=Major Healing Salve", "=ds=#sr# 300"};
		{ 12, "36749", "36749", "=q1=Spirited Precision Sickle", "=ds=#sr# 300"};
		{ 13, "36751", "36751", "=q1=Prospector's Magnifying Lens", "=ds=#sr# 300"};
		Prev = "Survival2";
		Back = "SURVIVALMENU";
	};

	Gardening = {
		{ 1, "51706", "51706", "=q1=Country Pumpkin Seeds", "=ds=#sr# 1"};
		{ 2, "51707", "51707", "=q1=Mountain Berry Bush Seeds", "=ds=#sr# 1"};
		{ 3, "51708", "51708", "=q1=Striped Melon Seeds", "=ds=#sr# 1"};
		{ 4, "51716", "51716", "=q1=Magic Mushroom Spores", "=ds=#sr# 1"};
		{ 5, "42068", "42068", "=q1=Wild Grape Seeds", "=ds=#sr# 1"};
		{ 6, "42069", "42069", "=q1=Wildhammer Yam Roots", "=ds=#sr# 1"};
		{ 7, "42070", "42070", "=q1=Sandswept Carrot Seeds", "=ds=#sr# 1"};
		{ 8, "45000", "45000", "=q1=Ordinary Cabbage Seeds", "=ds=#sr# 1"};
		Back = "GARDENINGMENU";
	};
